...
public class ModEntities {
    ...
    public static final EntityEntry<ProgrammablePalEntity> PROGRAMMABLE_PAL = CreatePP.REGISTRATE
            .entity("programmable_pal", ProgrammablePalEntity::new, MobCategory.CREATURE)
            .properties(properties -> properties.sized(0.625f, 0.875f))
            .register();
