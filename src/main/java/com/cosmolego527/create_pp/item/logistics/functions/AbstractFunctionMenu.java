...
public abstract class AbstractFunctionMenu extends GhostItemMenu<ItemStack> {
    protected AbstractFunctionMenu(MenuType<?> type, int id, Inventory inv, RegistryFriendlyByteBuf extraData) {
        super(type, id, inv, extraData);
    }

    protected AbstractFunctionMenu(MenuType<?> type, int id, Inventory inv, ItemStack contentHolder) {
