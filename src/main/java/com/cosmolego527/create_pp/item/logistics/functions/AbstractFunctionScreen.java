...
public abstract class AbstractFunctionScreen<F extends AbstractFunctionMenu> extends AbstractSimiContainerScreen<F> {
    ...
    protected AbstractFunctionScreen(F menu, Inventory inv, Component title, AllGuiTextures background) {
        ...
        for (IconButton button : tooltipButtons) {
            if (!button.getToolTip()
                ...
                button.setToolTip(button.getToolTip()
                        .get(0));
                button.getToolTip()
                        .add(TooltipHelper.holdShift(FontHelper.Palette.YELLOW, hasShiftDown()));
            }
        }
